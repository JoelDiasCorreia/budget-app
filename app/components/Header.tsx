...
export const Header: React.FC = () => {
    ...
    return (
        <header
            className="flex justify-between items-center px-10 py-3 bg-white border-b border-solid border-b-gray-200 max-sm:px-5">
                ...
                user && (
                    <div className="flex flex-1 gap-8 justify-end items-center">
                        ...
                        <a
                            ...
                            className="text-sm leading-5 cursor-pointer text-neutral-900 hover:text-blue-600 transition-colors"
                        >
                            Logout
                        </a>
